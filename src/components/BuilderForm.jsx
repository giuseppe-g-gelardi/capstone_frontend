...
const BuilderForm = () => {
  ...
  return (
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
              <p>Welcome to the Keyboard Builder(beta)!</p>
              <p>Here you can pick a layout, color and keycaps and submit them and it will display the keyboard with the options you chose. Have fun!</p>
            </div>
